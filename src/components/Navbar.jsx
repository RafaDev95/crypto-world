...
const Navbar = () => {
  ...
  const toggleBgLink = useColorModeValue('#394c64', '#145088')

  return (
    <Container h="100vh" w="380px" m={0}>
      <Flex p=".4rem" alignItems="center" w="100%">
        <Image boxSize="75px" alt="logo" src="/cryptologo.png" />
        <NextLink passHref href="/">
          <Link marginLeft=".8rem" fontSize="1.5rem">
            Crypto World
          </Link>
        </NextLink>
      </Flex>
      <Stack mt="1.2rem">
        ...
        <NextLink passHref href="/cryptocurrencies">
          <Link
            ...
            color={router.pathname === '/cryptocurrencies' ? ' white' : 'none'}
            _focus={{ border: 'none' }}
          >
            <AiOutlineFundProjectionScreen
              size="1.6rem"
